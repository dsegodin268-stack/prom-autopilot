...
# ─────────────── Характеристики російською (ПРАВИЛА §3a, правило `lang`) ───────
# 28.07. Бойовий рядок 4039: у РОСІЙСЬКОМУ описі стояв український блок
# «Характеристики: Сторона монтажу: Передня вісь; Вага: 0.05 кг». Причина —
# html_desc() перекладав ПІДПИСИ («Характеристики», «Аналоги / замена»), а самі
# назви й значення бере з details постачальника, який пише українською, і вони
# їхали в опис недоторканими.
#
# Словник ua2ru тут не рятує і не мусив: він зібраний під НАЗВИ ДЕТАЛЕЙ
# («пильник», «гальмівний»), слів «монтажу», «вісь», «вага» в ньому нема, а
# правило «або все, або нічого» чесно повертало рядок як був.
#
# Тому окремий словник — по СЛОВАХ, а не по фразах: постачальник пише і
# «Сторона монтажу», і «Сторона встановлення», і «Місце монтажу»; комбінацій
# більше, ніж варто перелічувати, а слів у них десяток. Слова, однакові в обох
# мовах, стоять тут ЯВНО («пластик»: «пластик»): мовчазний прохід невідомого
# слова — це рівно той дефект, який ми лагодимо.
CHAR_RU = {
    # службові
    "з": "с", "і": "и", "та": "и", "або": "или", "без": "без", "для": "для",
    "на": "на", "у": "в", "в": "в", "б": "б", "по": "по", "до": "до",
    "так": "да", "ні": "нет", "є": "есть", "немає": "нет", "все": "всё",
    # стан
    "стан": "состояние", "новий": "новый", "нова": "новая", "нове": "новое",
    "вживаний": "б/у", "відновлений": "восстановленный",
    # сумісність
    "сумісність": "совместимость", "сумісності": "совместимости",
    "марка": "марка", "маркою": "маркой", "марки": "марки",
    "модель": "модель", "моделлю": "моделью", "моделі": "модели",
    "рік": "год", "роки": "годы", "року": "года", "випуску": "выпуска",
    "автомобіля": "автомобиля", "автомобіль": "автомобиль", "авто": "авто",
    "серія": "серия", "серії": "серии", "покоління": "поколение",
    "версія": "версия", "модифікація": "модификация", "кузов": "кузов",
    "кузова": "кузова", "двигун": "двигатель", "двигуна": "двигателя",
    # тип / коди
    "тип": "тип", "типу": "типа", "вид": "вид",
    "запчастина": "запчасть", "запчастини": "запчасти",
    "деталь": "деталь", "деталі": "детали",
    "код": "код", "номер": "номер", "номери": "номера", "номера": "номера",
    "кросс": "кросс", "крос": "кросс", "артикул": "артикул",
    "оригінал": "оригинал", "оригінальний": "оригинальный",
    "оригінальна": "оригинальная", "аналог": "аналог", "аналоги": "аналоги",
    "техніка": "техника", "техніки": "техники",
    "легковий": "легковой", "вантажний": "грузовой", "мотоцикл": "мотоцикл",
    # місце / сторона
    "місце": "место", "місця": "места", "місці": "месте",
    "встановлення": "установки", "установки": "установки",
    "монтаж": "монтаж", "монтажу": "монтажа",
    "сторона": "сторона", "сторони": "стороны", "розташування": "расположение",
    "вісь": "ось", "осі": "оси", "вісі": "оси",
    "передня": "передняя", "передній": "передний", "переднього": "переднего",
    "задня": "задняя", "задній": "задний", "заднього": "заднего",
    "ліва": "левая", "лівий": "левый", "лівого": "левого",
    "права": "правая", "правий": "правый", "правого": "правого",
    "верхня": "верхняя", "верхній": "верхний", "нижня": "нижняя",
    "нижній": "нижний", "середня": "средняя", "середній": "средний",
    "внутрішня": "внутренняя", "внутрішній": "внутренний",
    "зовнішня": "наружная", "зовнішній": "наружный",
    "підвіска": "подвеска", "підвіски": "подвески", "салон": "салон",
    "салону": "салона", "колесо": "колесо", "колеса": "колеса",
    "маточина": "ступица", "маточини": "ступицы",
    # матеріал
    "матеріал": "материал", "матеріалу": "материала",
    "гума": "резина", "гуми": "резины", "гумовий": "резиновый",
    "метал": "металл", "металу": "металла", "металевий": "металлический",
    "пластик": "пластик", "пластику": "пластика", "сталь": "сталь",
    "сталі": "стали", "алюміній": "алюминий", "алюмінію": "алюминия",
    "чавун": "чугун", "чавуну": "чугуна", "мідь": "медь", "латунь": "латунь",
    "поліуретан": "полиуретан", "силікон": "силикон", "кераміка": "керамика",
    "тканина": "ткань", "шкіра": "кожа", "картон": "картон", "папір": "бумага",
    "скло": "стекло", "нержавіюча": "нержавеющая", "оцинкована": "оцинкованная",
    # розміри
    "вага": "вес", "ваги": "веса", "довжина": "длина", "довжини": "длины",
    "ширина": "ширина", "ширини": "ширины", "висота": "высота",
    "висоти": "высоты", "товщина": "толщина", "товщини": "толщины",
    "діаметр": "диаметр", "діаметра": "диаметра", "радіус": "радиус",
    "розмір": "размер", "розміри": "размеры", "площа": "площадь",
    "об'єм": "объём", "об'єму": "объёма", "форма": "форма",
    "різьба": "резьба", "різьби": "резьбы", "кріплення": "крепление",
    "отвір": "отверстие", "отвори": "отверстия", "отворів": "отверстий",
    # решта
    "кількість": "количество", "упаковка": "упаковка", "упаковки": "упаковки",
    "упаковці": "упаковке", "штук": "штук",
    "гарантія": "гарантия", "гарантії": "гарантии",
    "виробник": "производитель", "виробника": "производителя",
    "країна": "страна", "країни": "страны", "наявність": "наличие",
    "виконання": "исполнение", "призначення": "назначение",
    "особливості": "особенности", "потужність": "мощность",
    "напруга": "напряжение", "струм": "ток", "температура": "температура",
    "тиск": "давление", "клас": "класс", "стандарт": "стандарт",
    "сезон": "сезон", "зима": "зима", "літо": "лето",
    "всесезонний": "всесезонный", "колір": "цвет", "кольору": "цвета",
    "чорний": "чёрный", "білий": "белый", "сірий": "серый",
    "срібний": "серебристый", "синій": "синий", "червоний": "красный",
    "жовтий": "жёлтый", "зелений": "зелёный", "прозорий": "прозрачный",
}

# Одиниці виміру — ЗАКРИТИЙ список Prom (adding/rules.PROM_UNITS). Тут його
# російський двійник, рівно один в один: тест перевіряє, що жодна одиниця не
# лишилась без пари, інакше рядок характеристики мовчки випав би з опису.
UNIT_RU = {
    "100 г": "100 г", "бобіна": "бобина", "бухта": "бухта", "ват": "ватт",
    "г": "г", "година": "час", "гр/кв.м": "гр/кв.м", "дав": "дав",
    "день": "день", "добу": "сутки", "зміна": "смена", "кВт": "кВт",
    "карат": "карат", "кв.дм": "кв.дм", "кв.м": "кв.м", "кв.см": "кв.см",
    "кв.фут": "кв.фут", "кг": "кг", "кг/кв.м": "кг/кв.м", "км": "км",
    "комплект": "комплект", "куб.м": "куб.м", "л": "л", "лист": "лист",
    "м": "м", "мВт": "мВт", "мл": "мл", "мм": "мм", "моток": "моток",
    "місяць": "месяц", "мішок": "мешок", "набір": "набор", "об'єкт": "объект",
    "од.": "ед.", "палетомісць": "палетомест", "пара": "пара",
    "пог. м": "пог. м", "послуга": "услуга", "рулон": "рулон",
    "секція": "секция", "см": "см", "сотка": "сотка", "сторінка": "страница",
    "т": "т", "т/км": "т/км", "тиждень": "неделя", "упаковка": "упаковка",
    "хвилина": "минута", "чол.": "чел.", "шт": "шт", "шт.": "шт.",
    "ящик": "ящик",
}

_CYR_WORD = re.compile(r"[А-Яа-яІіЇїЄєҐґ']+")


def ru_char(s):
    """Назва або значення характеристики укр -> рос. '' якщо переклали НЕ повністю.

    Порожній рядок — це сигнал «не пускати в російський опис». Правило те саме,
    що й в ua2ru: або все, або нічого. Показати на один пункт менше — дрібниця,
    покупець усе одно бачить ПОВНИЙ набір у таблиці характеристик Prom (вона в
    картці одна на обидві мови). А от «Передня вісь» посеред російського тексту
    читається як недогляд і ламає російськомовний пошук по опису.

    Латиниця й цифри (F30, BMW, 0.05, 31306791712) не чіпаються: у обох мовах
    ...
    def repl(m):
        w = m.group(0)
        ru = CHAR_RU.get(w.lower())
        if ru is None:
            # Запасний шлях — словник назв деталей: у значеннях характеристик
            # трапляються самі деталі («Амортизатор», «Пильник»).
            ru = _word_ru(w.lower())
        if not ru or _UA_MARK.search(ru):
            ok[0] = False
            return w
        return ru.capitalize() if w[:1].isupper() else ru

    out = _CYR_WORD.sub(repl, t)
    return out if ok[0] else ""


def ru_unit(u):
    """Одиниця виміру укр -> рос. '' і для порожньої, і для невідомої."""
    return UNIT_RU.get(str(u or "").strip(), "")


def _ru_row(triple):
    """Трійка характеристики укр -> рос. None, якщо хоч одна частина не далась.

    Одиниця сувора нарівні з рештою: «Довжина: 100» без «мм» — це вже інше
    число, краще не показувати рядок узагалі."""
    n, u, v = triple
    ru_n, ru_v = ru_char(n), ru_char(v)
    ru_u = ru_unit(u)
    if not ru_n or not ru_v or (u and not ru_u):
        return None
    return (ru_n, ru_u, ru_v)
...
def html_desc(product, lang):
    ...
    # 28.07. Було `ua2ru(n)` для назви і СИРЕ `v` для значення — звідси в
    # російському описі бойового рядка 4039 стояло «Сторона монтажу: Передня
    # вісь» і «Вага: 0.05 кг». Тепер обидві частини (і одиниця теж) ідуть через
    # ru_char/ru_unit, а рядок, який не переклався ПОВНІСТЮ, у російський опис
    # просто не потрапляє — див. пояснення в ru_char().
    # Зріз [:4] стоїть ДО перекладу навмисно: обидва описи говорять про ОДНІ Й
    # ТІ САМІ характеристики, російський просто мовчить там, де слова нема.
    # Якби зрізали після, у російський опис підтягнувся б п'ятий пункт, якого
    # в українському нема.
    rows = list(details or [])[:4]
    if lang == "ru":
        rows = [r for r in (_ru_row(t) for t in rows) if r]
    if rows:
        lis = "".join(f"<li>{esc(n)}: {esc(v)}{(' ' + esc(u)) if u else ''}</li>"
                      for (n, u, v) in rows)
