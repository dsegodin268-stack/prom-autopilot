...
# його виправити.
# 28.07. Російських двійників тут спершу було лише два — назва й запити. Тому
# бойовий рядок 4039 проїхав крізь перевірку з українським блоком характеристик
# усередині РОСІЙСЬКОГО опису («Сторона монтажу: Передня вісь»): поля
# `description_ru` валідатор просто не бачив. Тепер перевіряються обидві мови в
# усіх п'яти текстових полях — інакше половина картки лишається без нагляду.
_LANG_FIELDS = (
    ("name", "ua", "назва"),
    ("name_ru", "ru", "назва"),
    ("description", "ua", "опис"),
    ("description_ru", "ru", "опис"),
    ("meta_title", "ua", "заголовок"),
    ("meta_title_ru", "ru", "заголовок"),
    ("meta_desc", "ua", "мета"),
    ("meta_desc_ru", "ru", "мета"),
    ("keywords", "ua", "запити"),
