...
#
# Позиція 2 — постійний вартовий «тип не впізнано». Така картка НЕ має потрапляти
# в бойову таблицю: інакше товар лягає в каталог Prom без групи й покупець його
# не знаходить. Вигадувати номер групи не можна.
#
# 27.07 вартовим був масляний фільтр, але того ж дня номери груп фільтрів звірили
# з вітрини власника й додали в GROUPS — фільтр почав мапитись і перестав бути
# вартовим. Тепер це водяна помпа. Якщо колись додасте «помпа» в GROUPS —
# переставте вартового на інший тип; тест test_sentinel_type_really_does_not_map
# у tests/test_groups.py впаде першим і скаже про це прямо.
FEED_ROWS = [
    ...
    ["11517586925", "Помпа водяна BMW 3 F30", "4200", "+", "5",
     "https://cdn.bm.parts/f1.jpg", "Система охолодження", "BMW",
     "Виробник", "", "BMW", "Тип", "", "механічна", "Матеріал", "", "алюміній"],
...
_PRODUCTS = {
    ...
    "11517586925": {
        "article": "11517586925", "brand": "BMW", "name": "Помпа водяна BMW 3 F30",
        "images": ["images/f1.jpg"], "nodes": "Система охолодження",
        "details": {"Виробник": "BMW", "Тип": "механічна", "Матеріал": "алюміній"},
        "oe": [{"number": "11517586925", "is_oem": True}],
        "cars": [{"brand": "BMW", "model": "3 F30", "years": "12-18"}],
    },
    "34116794300": {
